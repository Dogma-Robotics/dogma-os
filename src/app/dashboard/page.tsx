  ...
  <div style={{flex:1,display:"flex",overflow:"hidden",position:"relative"}}>
    ...
    <div style={{width:chatW,minWidth:240,borderLeft:"1px solid "+C.bd,background:C.bg1,display:"flex",flexShrink:0,position:"relative"}}>
      ...
      <div style={{padding:"8px 10px",borderBottom:"1px solid "+C.bd,flexShrink:0}}>
        <div style={{display:"flex",alignItems:"center",gap:6}}><div style={{display:"flex",alignItems:"center",gap:6}}><div style={{fontSize:13,fontWeight:700,color:curAgent.color}}>{curAgent.icon} {curAgent.name}</div><div style={{display:"flex",alignItems:"center",gap:4,padding:"2px 8px",borderRadius:3,background:oc.gateway.connected?"rgba(45,122,93,0.1)":"rgba(138,51,51,0.1)",border:"1px solid "+(oc.gateway.connected?"rgba(45,122,93,0.25)":"rgba(138,51,51,0.25)")}}><span style={{width:6,height:6,borderRadius:"50%",background:oc.gateway.connected?"#2D7A5D":"#8A3333"}}/><span style={{fontSize:9,fontWeight:700,color:oc.gateway.connected?"#2D7A5D":"#8A3333"}}>{oc.gateway.connected?"OpenClaw":"Cloud"}</span></div></div><div style={{display:"flex",alignItems:"center",gap:4,padding:"2px 8px",borderRadius:3,background:oc.gateway.connected?"rgba(45,122,93,0.1)":"rgba(138,51,51,0.1)",border:"1px solid "+(oc.gateway.connected?"rgba(45,122,93,0.25)":"rgba(138,51,51,0.25)")}}><span style={{width:6,height:6,borderRadius:"50%",background:oc.gateway.connected?"#2D7A5D":"#8A3333"}}/><span style={{fontSize:9,fontWeight:700,color:oc.gateway.connected?"#2D7A5D":"#8A3333"}}>{oc.gateway.connected?"OpenClaw":"Cloud"}</span></div></div>
